...
host = "192.168.1.55"  # 服务器端可以写"localhost"，可以为空字符串""，也为本机IP地址
port = 400  # 端口号
...
#lower = np.array([60, 100, 100])   # 适用于红黄绿乒乓球4<=h<=32
...
while True:
    ...
    teststr= (targetPos_x, targetPos_y)
    conn.sendall(str(teststr).encode()) 
